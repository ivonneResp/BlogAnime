...
<div class="row justify-content-center">
    ...
    <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
        <div class="col-10 col-md-12">
            ...
            <a href="/posthome" name="nickname" class="mx-3 pb-3 btn btn-outline-success d-block d-md-inline fw-bolder fst-italic fs-6 {{isset($categoryIdSelected)? '': 'selected-category'}} " >Todas</a>
              @foreach ($categories as $category)
              <a href="{{route('posthome.category', $category->name)}}" name="nickname" class=" mx-3 pb-3 btn btn-outline-success d-block d-md-inline fw-bolder fst-italic fs-6 {{ (isset($categoryIdSelected) && $category->id == $categoryIdSelected)? 'selected-category': '' }}" >{{$category->name}}</a>
              @endforeach
            </nav>
        </div>
    </div>
                ...
                <div class="col-md-4 col-12 justify-content-center mb-5" >
                    <div class="card m-auto" style="width: 18rem;" data-aos="fade-right" data-aos-duration="3000" >
                        ...
                        <div class="card-body" data-aos="flip-left" data-aos-duration="3000" style="background-color:#F7EFF3;" >
                            <small class="card-txt-category" style="background-color:#DE9EF5;">Categoría: {{$post->category->name}}</small>
