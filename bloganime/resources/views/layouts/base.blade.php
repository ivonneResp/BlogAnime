  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 menu">
        <li class="nav-item">
          <a name="nickname" class="nav-link active" aria-current="page" href="/home">Inicio
        ...
        <li class="nav-item">
          <a name="nickname" class="nav-link" href="/posthome">Posts
          <span class="border border-top"></span>
          <span class="border border-right"></span>
          <span class="border border-bottom"></span>
          <span class="border border-left"></span>
        ...
        <li class="nav-item">
          <a name="nickname" class="nav-link" href="/blog">Sobre el blog
          <span class="border border-top"></span>
          <span class="border border-right"></span>
          <span class="border border-bottom"></span>
          <span class="border border-left"></span>
        ...
        <li class="nav-item">
          <a name="nickname" class="nav-link" href="/nosotros">Nosotros
          <span class="border border-top"></span>
          <span class="border border-right"></span>
          <span class="border border-bottom"></span>
          <span class="border border-left"></span>
        ...
        <li class="nav-item">
          <a name="nickname" class="nav-link" href="/login">Iniciar sesión
          <span class="border border-top"></span>
          <span class="border border-right"></span>
          <span class="border border-bottom"></span>
          <span class="border border-left"></span>
        ...
        <div class="row">
          ...
          <div class="col-xs-6 col-md-3">
            ...
            <ul class="footer-links menu">
              <li><a href="/posthome">Posts
              <span class="border border-top"></span>
              <span class="border border-right"></span>
              <span class="border border-bottom"></span>
              <span class="border border-left"></span></a></li>
              <li><a href="/blog">Sobre el blog
              <span class="border border-top"></span>
              <span class="border border-right"></span>
              <span class="border border-bottom"></span>
              <span class="border border-left"></span>
          ...
          <div class="col-xs-6 col-md-3">
            ...
            <ul class="footer-links menu">
              ...
              <li><a href="/register">Registrarse
              <span class="border border-top"></span>
              <span class="border border-right"></span>
              <span class="border border-bottom"></span>
              <span class="border border-left"></span>
